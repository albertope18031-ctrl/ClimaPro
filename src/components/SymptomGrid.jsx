    ...
    <section id="diagnostico" className="py-20 bg-[#0B0F17]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#141B28] text-[#FFA336] text-xs font-bold uppercase tracking-wider mb-3 border border-[#232D42]">
            ...
            return (
              ...
              >
                <div>
                  ...
                  <p className="text-xs font-semibold text-[#FFA336] mb-3">{item.subtitle}</p>
                ...
                <div>
                  <div className="text-xs font-bold text-[#22C55E] bg-[#22C55E]/10 border border-[#22C55E]/30 p-2.5 rounded-xl mb-4 flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#22C55E] shrink-0" />
                    <span className="text-[11px] leading-tight">{item.solution}</span>
                  </div>

                  <button 
                    onClick={() => onSelectSymptom(item.actionValue)}
                    className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-[#FF6B00] to-[#FFA336] hover:from-[#E65D00] hover:to-[#FF6B00] text-white font-bold text-xs transition flex items-center justify-center gap-2 shadow-sm"
                  >
