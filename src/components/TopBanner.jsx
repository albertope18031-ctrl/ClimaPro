    ...
    <div className="bg-[#0B0F17] text-white text-xs sm:text-sm py-2.5 px-4 border-b border-[#232D42]">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3 font-sans">
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-bold font-tech bg-[#FF6B00]/15 text-[#FFA336] border border-[#FF6B00]/30 animate-pulse tracking-wide">
            <Zap className="w-3 h-3 text-[#FF6B00] fill-current" /> SERVICIO URGENTE HOY
          </span>
          <span className="text-slate-300 font-medium">
            Técnicos activos en <strong className="text-white font-semibold font-heading">Hermosillo y alrededores</strong>
          </span>
        </div>
        ...
        <div className="flex items-center gap-4 text-xs font-tech">
          ...
          <a 
            ...
            className="flex items-center gap-1.5 font-bold font-tech text-[#22C55E] hover:text-white transition bg-[#141B28] hover:bg-[#22C55E]/15 px-3 py-1 rounded-lg border border-[#232D42] hover:border-[#22C55E] tracking-wider"
          >
            <Phone className="w-3.5 h-3.5" /> 662 420 5643
          </a>
        </div>
      </div>
    </div>
