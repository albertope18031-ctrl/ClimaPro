      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-4">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#141B28] text-[#FFA336] border border-[#232D42] text-xs font-bold uppercase tracking-wider">
              <MapPin className="w-3.5 h-3.5 text-[#FF6B00]" /> Cobertura Local
            </span>
            ...
            <div className="grid sm:grid-cols-2 gap-3 pt-2">
              {hermosilloAreas.map((area, idx) => (
                <div key={idx} className="flex items-start gap-2 text-xs text-slate-200 bg-[#141B28] p-3 rounded-xl border border-[#232D42] shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#FF6B00] to-[#FFA336] text-white font-bold text-xs uppercase tracking-wider hover:from-[#E65D00] hover:to-[#FF6B00] transition shadow-lg shadow-[#FF6B00]/25"
                >
