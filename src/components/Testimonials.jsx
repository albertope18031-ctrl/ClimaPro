      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t, idx) => (
            <div key={idx} className="bg-[#141B28] p-8 rounded-3xl border border-[#232D42] flex flex-col justify-between space-y-4 hover:border-[#FF6B00] transition shadow-sm font-sans">
              ...
              <div className="pt-4 border-t border-[#232D42]">
                ...
                <div className="text-[11px] font-tech text-[#FFA336] font-semibold">{t.zone}</div>
