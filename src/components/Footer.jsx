...
export default function Footer() {
  return (
    <footer className="bg-[#070A10] text-slate-400 text-xs py-14 border-t border-[#232D42]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 pb-10 border-b border-[#232D42]">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="inline-flex items-center gap-2 text-[#FFA336] font-semibold text-xs">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              ...
              <li><a href="#tarifa" className="hover:text-[#FF6B00] transition">Tarifa Base $400 MXN</a></li>
            </ul>
          </div>
