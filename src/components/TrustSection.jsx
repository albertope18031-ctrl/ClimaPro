    ...
    <section id="garantia" className="py-20 bg-[#0B0F17] border-t border-[#232D42]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#141B28] text-[#FFA336] border border-[#232D42] text-xs font-bold font-tech uppercase tracking-widest mb-3">
            <Award className="w-4 h-4 text-[#FF6B00]" /> CALIDAD DE SERVICIO CERTIFICADA
          </span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="p-7 rounded-3xl bg-[#141B28] border border-[#232D42] hover:border-[#FF6B00] shadow-sm hover:shadow-md transition space-y-3">
            ...
            <h3 className="text-lg font-bold font-heading uppercase tracking-wide text-white"><span className="font-tech">90 DÍAS</span> GARANTÍA ESCRITA</h3>
          ...
          <div className="p-7 rounded-3xl bg-[#141B28] border border-[#232D42] hover:border-[#FF6B00] shadow-sm hover:shadow-md transition space-y-3">
            ...
            <h3 className="text-lg font-bold font-heading uppercase tracking-wide text-white">PROTOCOLO CERO DESASTRES</h3>
            <p className="text-xs font-sans text-slate-300 leading-relaxed">
          ...
          <div className="p-7 rounded-3xl bg-[#141B28] border border-[#232D42] hover:border-[#FF6B00] shadow-sm hover:shadow-md transition space-y-3">
            ...
            <h3 className="text-lg font-bold font-heading uppercase tracking-wide text-white">MANÓMETROS DIGITALES</h3>
            <p className="text-xs font-sans text-slate-300 leading-relaxed">
          ...
          <div className="p-7 rounded-3xl bg-[#141B28] border border-[#232D42] hover:border-[#FF6B00] shadow-sm hover:shadow-md transition space-y-3">
            ...
            <h3 className="text-lg font-bold font-heading uppercase tracking-wide text-white">PUNTUALIDAD SONORENSE</h3>
            <p className="text-xs font-sans text-slate-300 leading-relaxed">
